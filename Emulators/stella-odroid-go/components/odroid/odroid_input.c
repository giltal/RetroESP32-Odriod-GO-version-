...
volatile int odroid_paddle_adc_raw = 0;
...
odroid_gamepad_state odroid_input_read_raw()
{
    ...
    // Read paddle potentiometer (ADC2)
...
void odroid_input_gamepad_init()
{
	...
	// Configure paddle potentiometer on GPIO15 (ADC2_CHANNEL_3)
	adc2_config_channel_atten(PADDLE_ADC_CHANNEL, ADC_ATTEN_11db);
	paddle_adc_enabled = true;
	printf("[PADDLE] ADC2 CH3 (GPIO15) configured\n");
